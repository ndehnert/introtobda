...
The <b>portfolio package</b>, in particular to work with different stocks and indices (e.g., compare Apple Performance with S&P SPY Index)
...
**Your Answers here:**
<br>
1) Reference to Apple in line 8 (mytickers = c("SPY", <b>"AAPL"</b>))

<br>
2) Cumulative returns: 574.8, Average daily returns: 0.148, Standard deviation: 2.425
<br>
3)
Add mytickers = c("SPY", "AAPL", <b>"YHOO"</b>, "GOOG")
<br>
Run the dataSet1.R file again
<br>
...
**Your Answers here:**
<br>
1) nrow(transposedData) and ncol(transposedData)
<br>
2) 
Portfolio (of SPY, AAPL, YHOO, GOOG): ![](Rplot.png)
...
**Your Answers here:**
<br>
1) The source code is already set-up for data since 2001-01-01 (line 9, startdate: startDate = "2001-01-01"). New exercise data would require to run the entire dataSet1.R again (mark all lines, click "Run")
<br>
<br>
<br>
Portfolio (of SPY, AAPL, YHOO, GOOG, TSLA, MSFT): ![](Rplot02.png)
<hr>
<hr>
...
**Your Answers here:**
<br>
1) It gives back the sum of cells in myData matrix, which are identical ("!=") by values to the cells in StockReturns
<br>
2) 
<br>
<br>
